...
def main():
    ...
    # ---------------------------------------------------------------- E.4
    h1("E.4", "THE ZONE MODEL - WHICH THIS PROJECT HAS NEVER HAD")
    w("")
    ...
    w("")
    w("THERE IS NO EMP ZONE 1 ANYWHERE IN THE PROJECT, and no EMP Zone 0.")
    w("'Zone 2' has been used for four revisions with nothing to be the second")
    w("of.  The three zones below are DERIVED HERE.  [D]")
    w("")
    ...
    w("")
    w("THE DESIGN RULE THAT FOLLOWS, and it is the whole package in one line:")
    w("")
