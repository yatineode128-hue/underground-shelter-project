...
EMP design. **Six new open items EM-V1…V6**, so K.1b now holds **fourteen**.
...
- **`MASTER_PROJECT_STATE.pdf` is a stale render.** It is the user-supplied upload of
  ...
  **H.15** (WM3), **H.16 / H.17** (CAM1 / FS1), **H.18** (CAM2 / FS2) and **H.19** (EM1).
  **Read the `.md`.**
