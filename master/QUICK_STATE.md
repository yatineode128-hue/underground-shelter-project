...
box**, robust whatever the wind does, which is why SG2 chose geometry over meteorology); **the
PLUME half stays open, and must — a CBRN shelter with no wind direction data cannot state which
way a release drifts.** **EM-V2 and EL-V3: the circularity is now DOCUMENTED and both stay open**
— the enclosure is sized to fit bay 3, the 1.50 kW is chosen to give the enclosure a basis, **and
...
Updated **15 Sep 2026** for Works Management **WM4** (master Part **H.38**) — **the bill priced
from the Maharashtra PWD State Schedule of Rates 2022-23**, the 624-page schedule the owner
supplied. **The project's first bill priced from a published schedule of rates**: WM1 deliberately
carried no rate because no item number could be verified, and now every civil line can cite one,
with the SSR page it was read from. **No quantity moved** — where a WM1 line was split to reach two
SSR items the parts sum back exactly, and the audit checks each one. **Total of items ₹1,52,83,278
· estimated cost ₹2,07,39,408 — CIVIL ONLY and a declared lower bound**: everything with no SSR
item or no specification is EXCLUDED, not estimated. **The owner's own rates come out 31.6 % below
schedule** on the 21 comparable lines. **Seven new open items WM4-V1…V7. No design value, tag,
quantity, date or float changed; WM1, WM2 and WM3 preserved; the main staircase untouched.**
...
| **Works Management — rates** | **WM4** (15 Sep 2026, master **H.38**) — **the project's first bill priced from a published schedule of rates.** Source: the owner's own **`SSR 22-23 MH (1).pdf`**, Maharashtra PWD **State Schedule of Rates 2022-23**, 624 pages, effective 25.07.2022. **WM1's 90 measured items, unchanged** — where a line was split to reach two SSR items the parts sum back exactly, and the audit checks each one. **114 bill lines: 53 at a published SSR item, 21 on a stated `[A]` assumption, 15 included in another rate and not payable twice, 25 NOT PRICED.** **Total of items ₹ 15,283,278 · estimated cost ₹ 20,739,408** — **CIVIL ONLY, a declared lower bound**: blast doors, hatches, valves, NBC trains, EMP enclosure, generator, sump pumps, commissioning, waterstops, spiral stair, flooring, window W1, berm and camouflage **have no SSR item or no specification and are EXCLUDED, not estimated**. Four things the schedule settled: **10 % overheads + 10 % profit + 1 % cess are already IN the rate** (so the owner's extra 10 % OH&P is a double count and is not made), **formwork is already in the concrete rate** (F-01, F-02 and four other groups go to nil), **a grade the SSR does not publish is derived by its own cement-consumption rule** (checked against the SSR's own published steps first), and **excavation below 3.0 m attracts +20 % / +30 %** — the bulk dig is billed in six depth bands reproducing E-02a's 344.4 and E-02b's 993.84 exactly. **The rock is BROKEN, NOT BLASTED** (the project's own methodology), so SSR **21.20** governs and the three blasting items do not apply at all. **The owner's own rates come out +31.6 % against schedule** on the 21 comparable lines — concentrated in R.C.C. wall casting, rock excavation and reinforcement. **RC4-01 and RC4-02, recorded as `[A] NOT PRICED`, now have a rate; the ruling and the quantity tag are untouched.** **18 consistency checks, 18 pass; 203 workbook formulas evaluated. No design value, quantity, tag, date or float changed; WM1/WM2/WM3 preserved; main staircase untouched** |
